...
import type { Deserialize, Serialize } from '@grpc/grpc-js/build/src/make-client';
import { Metadata } from '@grpc/grpc-js/build/src/metadata';
import type { ObjectReadable, ObjectWritable } from '@grpc/grpc-js/build/src/object-stream';
import type { StatusObject, PartialStatusObject } from '@grpc/grpc-js/build/src/call-interface';
import type { Deadline } from '@grpc/grpc-js/build/src/deadline';
import type { ServerInterceptingCallInterface } from '@grpc/grpc-js/build/src/server-interceptors';
