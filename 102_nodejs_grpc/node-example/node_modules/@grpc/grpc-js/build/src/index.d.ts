...
import { ChannelCredentials, VerifyOptions } from '@grpc/grpc-js/build/src/channel-credentials';
...
import { Deserialize, loadPackageDefinition, makeClientConstructor, MethodDefinition, Serialize, ServerMethodDefinition, ServiceDefinition } from '@grpc/grpc-js/build/src/make-client';
import { Metadata, MetadataOptions, MetadataValue } from '@grpc/grpc-js/build/src/metadata';
import { ConnectionInjector, Server, ServerOptions, UntypedHandleCall, UntypedServiceImplementation } from '@grpc/grpc-js/build/src/server';
