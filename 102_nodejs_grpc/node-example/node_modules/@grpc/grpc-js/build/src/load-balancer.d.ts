...
import { Endpoint, SubchannelAddress } from '@grpc/grpc-js/build/src/subchannel-address';
import { ConnectivityState } from '@grpc/grpc-js/build/src/connectivity-state';
import { Picker } from '@grpc/grpc-js/build/src/picker';
import type { ChannelRef, SubchannelRef } from '@grpc/grpc-js/build/src/channelz';
import { SubchannelInterface } from '@grpc/grpc-js/build/src/subchannel-interface';
import { LoadBalancingConfig } from '@grpc/grpc-js/build/src/service-config';
/**
...
export interface LoadBalancer {
     ...
     *     if one was provided
     */
    updateAddressList(endpointList: Endpoint[], lbConfig: TypedLoadBalancingConfig, channelOptions: ChannelOptions): void;
    /**
