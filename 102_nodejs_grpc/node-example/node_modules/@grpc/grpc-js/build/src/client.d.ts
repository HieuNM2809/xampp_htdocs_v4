import { ClientDuplexStream, ClientReadableStream, ClientUnaryCall, ClientWritableStream, ServiceError, SurfaceCall } from '@grpc/grpc-js/build/src/call';
...
import { Interceptor, InterceptorProvider } from '@grpc/grpc-js/build/src/client-interceptors';
import { ServerUnaryCall, ServerReadableStream, ServerWritableStream, ServerDuplexStream } from '@grpc/grpc-js/build/src/server-call';
